...
DocumentReference get currentUserReference => currentUser?.user != null
    ? UtilisateursRecord.collection.doc(currentUser.user.uid)
    : null;

UtilisateursRecord currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UtilisateursRecord.getDocument(
                  UtilisateursRecord.collection.doc(uid))
              .handleError((_) {}),
    )
